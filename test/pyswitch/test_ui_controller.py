...
class TestUiController(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(display_driver.tft.root_group, display.splash)
        ...
        self.assertEqual(display_driver.tft.root_group, display_2.splash)
    ...
    def test_mappings(self):
        ...
        self.assertEqual(display_driver.tft.root_group, ui._UiController__current_splash_element.splash)
