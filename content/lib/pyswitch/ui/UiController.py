...
class UiController(Updater, Updateable):
    ...
    def init(self, appl):
        self.__appl = appl
        self.font_loader = self.__font_loader

        splash_element = self.__splash_callback.get_root()
        splash_element.font_loader = self.__font_loader
        splash_element.make_splash(self.__font_loader)
        self.__appl.splash = splash_element.splash
    ...
    def show(self):
        ...
        try:
            self.__display_driver.tft.root_group = splash_element.splash
