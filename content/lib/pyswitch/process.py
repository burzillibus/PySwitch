...
if not _get_option(_Config, "exploreMode"):
    ...
    # Load the selected controller profile. The original Kemper profile remains available.
    if _get_option(_Config, "deviceProfile", "kemper") == "gx100":
        from communication_gx100 import Communication as _Communication
    else:
    ...
    try:
        ...
        if _get_option(_Config, "deviceProfile", "kemper") == "gx100":
            from inputs_gx100 import Inputs as _Inputs
        else:
