...
Config = {
    # Active controller profile: "gx100" uses the MIDI DIN port; "kemper" keeps the original setup.
    "deviceProfile": "gx100",
    ...
    # This costs about 11kB of RAM, so it is disabled by default. Enable it only when needed.
    "enableMidiBridge": False,

    # Skip DisplayLabel background rectangles to save RAM on small heaps.
    # Set to False if you want the colored header/footer backgrounds back.
    "disableDisplayBackgrounds": True,

    # Optional 240x240 BMP background. It is kept off by default to preserve RAM.
    # Set to True only after confirming the controller remains responsive.
